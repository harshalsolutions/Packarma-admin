...
const AddUserModal: FC = function () {
  ...
  return (
    <>
      <Button color="lime" onClick={() => setOpen(true)}>
        <div className="flex items-center gap-x-3">
      ...
      <Modal onClose={() => setOpen(false)} show={isOpen}>
        ...
        <Modal.Footer>
          <Button color="lime" onClick={() => setOpen(false)}>
            Add user
          </Button>
        </Modal.Footer>
      </Modal>
          ...
          <Table.Cell className="w-4 p-4">
            <div className="flex items-center">
              <input
                ...
                type="checkbox"
                className="h-4 w-4 rounded border-gray-300 bg-gray-50 focus:ring-4 focus:ring-lime-300 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-lime-600"
              />
  ...
  return (
    <div className="sticky right-0 bottom-0 w-full items-center border-t border-gray-200 bg-white p-4 dark:border-gray-700 dark:bg-gray-800 sm:flex sm:justify-between">
      ...
      <div className="flex items-center space-x-3">
        <a
          href="#"
          className="inline-flex flex-1 items-center justify-center rounded-lg bg-lime-700 py-2 px-3 text-center text-sm font-medium text-white hover:bg-lime-800 focus:ring-4 focus:ring-lime-300 dark:bg-lime-600 dark:hover:bg-lime-700 dark:focus:ring-lime-800"
        >
