  ...
  useEffect(() => {
    const fetchData = async () => {
      const results = await Promise.allSettled([
        api.get(`${BACKEND_API_KEY}/dashboard/total-users`),
        api.get(`${BACKEND_API_KEY}/dashboard/total-free-subscriptions`),
        api.get(`${BACKEND_API_KEY}/dashboard/total-paid-subscriptions`),
        ...
        api.get(`${BACKEND_API_KEY}/dashboard/user-comparison`),
        api.get(`${BACKEND_API_KEY}/dashboard/referral-task-completion`),
      ]);
